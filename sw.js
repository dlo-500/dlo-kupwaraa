...
const STATIC_CACHE = 'dlo-kupwara-static-v4';
const DATA_CACHE   = 'dlo-kupwara-data-v4';
...
self.addEventListener('fetch', event => {
  ...
  // NEVER cache these. This data is sensitive and often accessed on shared
  // office computers; caching it would let it survive logout in the
  // browser's Cache Storage, retrievable by the next person to use the
  // machine. Always go straight to the network, no persistence.
